      ...
      >
        <View style={[styles.mainContainer, isTabletOrWeb && styles.tabletContainer]}>
          <View style={styles.headerContainer}>
            <Text style={styles.title}>Repetera</Text>
            <Text style={styles.subtitle}>
              Repetera ord, fraser och moment du har mött i kursen.
            </Text>
          </View>
          ...
          <View style={styles.emptyCard}>
            <View style={styles.iconCircle}>
              <Icon name="refresh-outline" size={26} color="#1E4E8C" />
            </View>
            <Text style={styles.emptyTitle}>Ingenting att repetera ännu</Text>
            <Text style={styles.emptyBody}>
              Här kommer du att kunna repetera ord och fraser från uppdrag du har genomfört.
            </Text>
